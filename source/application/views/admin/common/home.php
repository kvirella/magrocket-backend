...
<div class="container">
        <h2><?php echo $this->lang->line('__LBL_DASHBOARD__'); ?></h2>
	     <div class="alert alert-info">
    	  ...
    	  <p>
    	  		MagRocket is a complete backend solution and REST API for supporting Newsstand applications built with the <a href="http://www.bakerframework.com" target="_blank">Baker Framework</a>.
		  </p>
		  <p>
				For information and helpful tutorials on using MagRocket, please visit <a href="http://www.magrocket.com" target="_blank">MagRocket.com</a> or view the bundled help documentation that accompanied this source distribution.    	  
    	  </p>
    	  <p>
				The administration console allows you to manage / view the following backend data related to your MagRocket installation.
			    ...
			    <tr>
			    <td>Publication</td>
			    <td>Defines the list of publications that you are supporting with your MagRocket backend installation.  Each publication would correspond to a deployed iOS Baker Newsstand application.</td>
			    </tr>
  			    <tr>
			    <td>Issues</td>
			    <td>Defines the available issues for each of your Publications being managed by MagRocket.  These issues are what show up in your iOS Baker Newsstand application.</td>
			    </tr>
			    <tr>
			    <td>Purchases</td>
		  ...
		  <h3>Get Started!</h3>    	  
    	  <p>
    	  		To get started using MagRocket, you should create a Publication that corresponds to your iOS Baker Newsstand application.  After you create the Publication, you can add Issues.
				 <ul>
    	  ...
    	  <p>
    	  		To manage your Publications and Issues, use the <strong>Publication Management</strong> dropdown menu.  To view/manage the backend MagRocket data, use the <strong>Data Browser</strong> dropdown menu, both located at the top of this page.
    	  </p>
        <hr />
        <footer>
