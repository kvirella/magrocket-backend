...
$(function () {
    // validate signup form on keyup and submit
    var validator = $("#publicationform").validate({
        rules: {
            NAME:{
                required: true,
                minlength: 5
...
$(function () {
    ...
    var validator = $("#issueform").validate({
        ...
        messages: {
            NAME: "Enter the Issue name.",
            TITLE: "Enter the Issue title.",
            INFO: "Enter the Issue info.",
            DATE: "Enter the Issue publication date.",
            COVER: "Enter the Issue Cover URL.",
            URL: "Enter the Issue HPUB URL.",
            ITUNES_SUMMARY: "Enter the Issue iTunes Summary.",
            ITUNES_COVERART_URL: "Enter the Issue iTunes Coverart URL.",
            ITUNES_PUBLISHED: "Enter the Issue iTunes Publish Date.",
            ITUNES_UPDATED: "Enter the iTunes Issue Updated Date."              
...
$(function () {
    $('.data-tbl-striped').dataTable({
        ...
        "iDisplayLength": 10,
        "oLanguage": {
            "sLengthMenu": "<span class='lenghtMenu'> _MENU_</span><span class='lengthLabel'>Publications per page:</span>",
        },
        "sDom": '<"table_top clearfix"fl<"clear">>,<"table_content"t>,<"table_bottom"p<"clear">>'
...
$(function () {
    $('.data-tbl-striped-issues').dataTable({
			 "aoColumnDefs": [
        ...
        "iDisplayLength": 10,
        "oLanguage": {
            "sLengthMenu": "<span class='lenghtMenu'> _MENU_</span><span class='lengthLabel'>Issues per page:</span>",
        },
        "sDom": '<"table_top clear fix"fl<"clear">>,<"table_content"t>,<"table_bottom"p<"clear">>'
